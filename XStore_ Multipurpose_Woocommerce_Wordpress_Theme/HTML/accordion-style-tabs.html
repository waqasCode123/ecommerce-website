...
<nav id="menu" class="menu slideout-menu">
	...
	<ul>
		<li class="menu-parent">
			...
			<ul class="sub-menu">
				<li class="menu-back"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</li>
		...
		<li class="menu-parent">
			<a href="#">Blog<i class="fa fa-angle-right" aria-hidden="true"></i></a>
			<ul class="sub-menu">
				<li class="menu-back"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</li>
		...
		<li class="menu-parent">
			<a href="#">Portfolio<i class="fa fa-angle-right" aria-hidden="true"></i></a>
			<ul class="sub-menu">
				<li class="menu-back"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</li>
		...
		<li class="menu-parent">
			<a href="#">Pages featires<i class="fa fa-angle-right" aria-hidden="true"></i></a>
			<ul class="sub-menu">
				<li class="menu-back"><i class="fa fa-angle-left" aria-hidden="true"></i>Back</li>
...
<main id="panel" class="panel">
	...
	<div class="container">
		<div class="single-product">
			<div class="row">
				<div class="col-md-9 product-content">
					<div class="row">
							...
							<div id="carousel-example-generic" class="carousel carousel-product" data-ride="carousel" data-interval="false">
								...
								<div class="carousel-inner">
								    <div class="item active">
										<img src="http://placehold.it/410x545" alt="product-img" class="img-responsive">
								    </div>
								...
								<ul class="thumbnails-carousel clearfix">
									<li><img src="http://placehold.it/90x120" alt="thumbnails"></li>
									<li><img src="http://placehold.it/90x120" alt="thumbnails"></li>
									<li><img src="http://placehold.it/90x120" alt="thumbnails"></li>
									<li><img src="http://placehold.it/90x120" alt="thumbnails"></li>
								</ul>
						...
						<div class="col-md-6 col-sm-12">
							<h4 class="title">Hope Power Dress</h4>
							<a href="#" class="products-cats">Dresses</a>
							...
							<div class="description">
								...
								<p><b>Aculis faucibus penatibus condimentum</b></p>
								<p>60% Ultrices 40% Commodo</p>
								<p>Ullamcorper condimentum sem.</p>
							</div><!--description-->
							<div class="size-guide">
								<a href="#" data-toggle="modal" data-target="#size-guide">Sizing guide</a>
							</div><!--size-guide-->
				...
				<div class="col-md-3 single-product-sidebar">
					<div class="product-brands">
						<img src="http://placehold.it/200x50" alt="brand">
					...
					<div class="slider">
						...
						<div class="sidebar-slider">
							<div class="item">
								<div class="product">
									<img src="http://placehold.it/90x120" alt="Owl Image">
			...
			<div class="accordion-content-product">
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					<div class="panel panel-default">
					    ...
					    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
					   		<div class="panel-body description-tab">
								<p>Feugiat eget dictum cum mollis a mi sem eu donec hac semper dapibus interdum cras cras ac parturient gravida libero vulputate suscipit a. Placerat tortor ultrices curabitur nulla ullamcorper a scelerisque convallis risus nibh cursus nam vestibulum netus parturient accumsan mus a massa. Vestibulum non adipiscing a suspendisse est semper ligula montes maecenas condimentum adipiscing pretium suspendisse ut a rutrum a per vestibulum fusce vestibulum a. Mauris bibendum adipiscing convallis condimentum etiam praesent penatibus dignissim condimentum iaculis id posuere metus non suspendisse etiam a suspendisse urna vitae natoque ut a ante.</p>
								<ul class="circle">
									<li>Id nisi fermentum adipiscing gravida scelerisque potenti parturient mi et parturient ridiculus diam leo class consectetur nam.</li>
									<li>A est a pretium suscipit suscipit purus scelerisque et fusce diam etiam a vestibulum platea a quis vitae metus dignissim parturient sed in a tempor justo suspendisse.</li>
									<li>Nunc sit torquent adipiscing lectus a condimentum est diam consequat sed maecenas in a tincidunt a fringilla sociosqu imperdiet.</li>
								</ul>
								<p>Quis commodo consequat feugiat sapien ut tempor laoreet a suspendisse arcu parturient proin nulla tortor inceptos elementum penatibus vestibulum ac in sagittis ac maecenas natoque felis quam. Venenatis varius a quam quis cum placerat condimentum turpis curabitur diam adipiscing dui massa sit fames tempor eros vel egestas dapibus mattis. Leo elit dui adipiscing ad eleifend congue primis curabitur etiam mi scelerisque nibh habitasse consectetur sapien lacinia condimentum eget. Gravida cubilia justo lacinia scelerisque purus justo orci a vestibulum donec primis suspendisse dignissim class tortor phasellus vestibulum duis ullamcorper natoque leo cursus condimentum mauris consequat ac. A facilisis scelerisque ac condimentum euismod facilisis consectetur torquent risus fermentum cum maecenas parturient a parturient ut ullamcorper a sapien.</p>
					   		</div>
					    </div>
					</div>
					<div class="panel panel-default">
					    <div class="panel-heading" role="tab" id="headingTwo">
					    	<h4 class="panel-title">
					        	<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Additional Information</a>
					    	</h4>
					    </div>
					    	...
					    	<div class="panel-body">
					       		<table class="shop-attributes">
									<tbody>
										...
										<tr>
											<th>Dimensions</th>
											<td class="product_dimensions">60 x 40 x 60 cm</td>
										</tr>
										<tr>
											<th>Washcare</th>
											<td><p>Dry Clean</p></td>
										...
										<tr>
											<th>Other info</th>
											<td><p>Ullamcorper nisl mus integer mollis vestibulu</p></td>
										</tr>
									</tbody>
								</table>
					    	</div>
					...
					<div class="panel panel-default">
					    <div class="panel-heading" role="tab" id="headingThree">
					    	<h4 class="panel-title">
					        	<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Reviews (1)</a>
					    	</h4>
					    </div>
							...
							<div id="reviews" class="panel-body">
								<div class="form-rating">
									...
									<ul>
										...
										<li><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></li>
										<li><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></li>
										<li><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i></li>
								...
								<div class="comments">
									<div class="title">1 review for Hope Power Dress</div>
									<ul>
										<li>
											<img src="images/autor.png" alt="autor">
											<div class="comment-text">
												<p class="name"><img src="images/star.png" alt="star">Vania <time>March 30, 2016</time></p>
												<div class="description">
													<p>60% Ultrices 40% Commodo.</p>
													<p>Ullamcorper condimentum sem.</p>
												</div>
										...
										<li>
											...
											<div class="comment-text">
												<p class="name"><img src="images/star.png" alt="star">Vania <time>March 30, 2016</time></p>
												<div class="description">
													<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus at excepturi, dolorum voluptatem et laudantium esse vel suscipit doloremque alias omnis, facilis voluptates rem officia ipsa obcaecati, fuga incidunt libero.</p>
												</div>
											</div>
										</li>
									</ul>
					...
					<div class="item">
						<div class="product">
							<div class="mask-product">
								<img src="http://placehold.it/255x340" alt="Owl Image">
								<img class="image-swap" src="http://placehold.it/255x340" alt="swiper-slide">
...
<!-- Modal -->
<div class="modal fade" id="size-guide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
