...
<main id="panel" class="panel">
	...
	<div class="content-page about-us">
		<div class="bg-slider">
			<div class="container">
				<div class="row">
					<div class="col-md-5 text-center">
						<h4>Easy to edit text</h4>
						<h2>About Us</h2>
			...
			<div class="container">
				<div class="row banner-text text-center">
					<div class="col-md-7 text-left">
						<img src="http://placehold.it/500x700" alt="about-woman">
					</div>
					<div class="col-md-5 ">
						<div class="inside">
							<h4>Easy to edit text</h4>
							<h2>Introduction</h2>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate.</p>
						</div>
					</div>
				</div><!--banner-text-->
				<div class="row banner-text text-center">
					...
					<div class="col-md-7 text-right">
						<img src="http://placehold.it/500x700" alt="about-man">
					</div>
				</div><!--banner-text-->
			</div>
								...
								<div class="item">
									...
									<div class="testimonial-info">
										...
										<cite class="author">
											...
											<span>Lead Developer</span>
					 						<span class="url">
					 							<a href="https://www.8theme.com">https://www.8theme.com</a>
					 						</span>
										</cite>
									</div>
								</div><!--item-->
		...
		<div class="container">
			<div class="row icon-text type-2">
		...
		<div class="row brands">
			<div class="col-md-12">
				<div class="owl-brands">
					<div class="item">
						<img src="http://placehold.it/200x50" alt="brand-prada">
					</div>
					<div class="item">
						<img src="http://placehold.it/200x50" alt="brand-kenzo">
					</div>
					<div class="item">
						<img src="http://placehold.it/200x50" alt="brand-cartier">
					</div>
					<div class="item">
						<img src="http://placehold.it/200x50" alt="brand-bv">
					</div>
					<div class="item">
						<img src="http://placehold.it/200x50" alt="brand-kenzo">
					</div>
